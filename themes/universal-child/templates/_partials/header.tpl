    ...
    <div class="row">
      ...
      <div class="col-md-2">
        ...
        <a class="hidden-md-down mx-2 mx-xl-3" href="{$urls.base_url}">
          ...
          {*<img src="/themes/universal-child/assets/img/logo-prunier-text-only.png" alt="Vendeur de caviar de qualité" width="183" height="100" loading="eager" class="logomin">*}
	  {*<img src="/themes/universal-child/assets/img/logo-prunier-only.jpg" alt="Vendeur de caviar de qualité" width="60" height="60" loading="eager" class="logomin">*}
  ...
  <div class="header-top" style="box-shadow: 0 3px 3px #e0e0e0 !important;margin-bottom:3px !important">
	...
	{*<img class="menu-icon-open show" src="{$urls.img_url}logo-modile-prunier-text-only.png" alt="acheter du caviar" width="20" height="20">
      ...
      <a class="position-absolute hidden-lg-up" id="header-logo" href="{$urls.base_url}">
        {*<img src="{$shop.logo}" alt="Vendeur de caviar français restaurant paris" width="90" height="54" loading="eager">*}

	{*<img src="{$urls.img_url}logo-modile-prunier-text-only.png" alt="Vendeur de caviar français restaurant paris" width="90" height="54" loading="eager">*}
	<img src="{$urls.img_url}logo-prunier-text-black.png" alt="Vendeur de caviar français restaurant paris" width="90" height="54" loading="eager">
