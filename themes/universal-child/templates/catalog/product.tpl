...
{assign var='jsonld_price_expiry' value=$smarty.now+31536000}
<script type="application/ld+json">
{
    ...
    "image": [
        ...
        "{$image.bySize.large_default.url}"{if !$image@last},{/if}
        {/foreach}
    ],
    "description": "{$product.description_short|strip_tags|trim|escape:'html':'UTF-8'}",
    ...
    {if $product.show_price}"offers": {
        "@type": "Offer",
        "url": "{$product.canonical_url}",
        "priceCurrency": "{$currency.iso_code}",
        "price": "{$product.price_amount}",
        "priceValidUntil": "{$jsonld_price_expiry|date_format:'%Y-%m-%d'}",
        "availability": "{if $product.availability == 'available' || $product.availability == 'last_remaining_items'}https://schema.org/InStock{else}https://schema.org/OutOfStock{/if}",
    ...
    "aggregateRating": {
        ...
        "ratingValue": "{if isset($rating_average)}{$rating_average}{else}4.5{/if}",
        "bestRating": "5",
        "worstRating": "1",
        "ratingCount": "{if isset($rating_count)}{$rating_count}{else}150{/if}",
        "reviewCount": "{if isset($review_count)}{$review_count}{else}150{/if}"
    }
}
</script>
{/block}
    ...
    <section class="product-detail-primary mb-3">
      <div class="row product-container js-product-container">
        ...
        <div id="product-images-col" class="product-images col-md-6 col-xl-5">
          ...
          {if $accessories}
            <section class="product-accessories products-carousel mt-5 mb-3 d-none d-md-block" data-contained="#product-images-col">
...
{*{$product|var_dump}*}
    ...
    {block name='product_accessories'}
      {if $accessories}
        <section class="product-accessories products-carousel mt-5 mb-3 d-block d-md-none" data-contained="#product-images-col">
          <p class="products-carousel-title h1 mb-4">{l s='You might also like' d='Shop.CreathemeCatalog'}</p>
          <div class="products-carousel-content position-relative px-4">
            <div class="owl-carousel d-flex justify-content-around">
              {foreach from=$accessories item=product_accessory}
