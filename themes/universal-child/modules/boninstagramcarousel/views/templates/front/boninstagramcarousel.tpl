...
<section id="boninstagram" class="col-12">
  <div class="instagram-carousel-container clearfix block {if $display_caroucel}bonhidden{/if}">
    ...
    <h2 class="display-4 text-center mt-3 mb-5 py-5">
      <span class="position-relative">
        <span class="circles-text position-relative">
          {l s='[1]Caviar[/1] in your feed' d='Shop.CreathemeModules' sprintf=['[1]' => "<span class='font-weight-bold'>", '[/1]' => '</span>']}
        </span>
    ...
    <div class="instagram-home-title position-relative font-weight-bold text-uppercase">
      <a href="https://www.instagram.com/pruniercaviar" target="_blank" style="color: #27b7b1;">@pruniercaviar</a>
    </div>

    <div class="block_content">
      <ul class="instagram-list list-unstyled {if $display_caroucel}owl-carousel-instagram owl-carousel owl-theme owl-loaded owl-drag{else}clearfix{/if}">
        {for $i=1 to $limit}
          <li class="instagram-item iii {if !$display_caroucel}instagram-item-gallery{/if} revealOnScroll animated fadeInUp" data-animation="fadeInUp" >
